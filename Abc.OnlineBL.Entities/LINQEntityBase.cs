...
namespace Abc.OnlineBL.Entities
{
	...
	public abstract class LINQEntityBase : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private void BindToEntityEvents()
		{
			...
			{
				childEntityChanged.PropertyChanged += new PropertyChangedEventHandler(OnPropertyChanged);
				childEntityChanging.PropertyChanging += new PropertyChangingEventHandler(OnPropertyChanging);
			}
