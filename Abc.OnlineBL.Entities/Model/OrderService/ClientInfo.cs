...
namespace Abc.OnlineBL.Entities.Model.OrderService
{
	public class ClientInfo
	{
		public int ClientID;
		public string ClientName;
		// This Office name can come from the ClientsDisplayInfo table,
		...
		public string ToHTML()
		{
			...
			sb.AppendFormat("<tr><td>Agent Name:</td><td>{0}</td></tr>", ClientName);
			sb.AppendFormat("<tr><td>Office:</td><td>{0}</td></tr>", ActualOffice);
